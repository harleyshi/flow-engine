...
public class BuilderDefinitionVisitor implements DefinitionVisitor{
    ...
    private final Map<String, IComponent<?, FlowCtx>> omponents = new ConcurrentHashMap<>();
    ...
    public void visit(IfNodeDefinition ed) {
        ...
        omponents.put(ed.identify(), ifBuilder.build());
    }
    ...
    public void visit(ScriptNodeDefinition ed) {
        ScriptBuilder<?, FlowCtx> scriptBuilder = Builders.script()
                ...
                .script(ed.getScript());
        omponents.put(ed.identify(), scriptBuilder.build());
    }
    ...
    public void visit(StandardNodeDefinition ed) {
        ...
        omponents.put(ed.identify(), standardComponent);
    }
    ...
    public DAGEngine<FlowCtx> getEngine() {
        AssertUtil.notEmpty(this.omponents, "omponents must not be empty!");
        this.omponents.forEach((key, value) -> dagEngine.addComponent(key, value));
        return dagEngine;
    }
