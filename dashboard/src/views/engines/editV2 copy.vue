...
const data = [
  ...
  { id: "1", type: "business", label: "Node 1", position: { x: 250, y: 70 }, customProperty: "属性1" },
...
const nodeTypes = ref({
  ...
  request: markRaw(request),
  response: markRaw(response),
...
// VueFlow hook
const { onNodeClick, addNodes, nodes, edges } = useVueFlow();
...
const logToObject = () => {
  ElMessage.info(JSON.stringify(elements.value));
};
